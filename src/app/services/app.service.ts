...
import * as c from './../objects/app.constant';
...
export class AppService {
  ...
  alertErr(err: any) {
    ...
    let message =
      'Error! We are unable to process your request. Request response is emtpy. Please try again later.';
    if (_.isEmpty()) {
      title = 'Ooops! ' + error.error;
      message =
        'Error! We are unable to process your request at the moment. ' +
        error.message +
        '. Path: ' +
        error.path;
    }
